...
/*   Updated: 2022/01/13 20:30:21 by jofelipe         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	draw_screen(t_data *data)
{
	...
	draw_rays(data);
	put_image_to_screen(&data->img[RAYS], &data->img[SCREEN], BLACK);
	put_image_to_screen(&data->img[BG], &data->img[SCREEN], BLACK);
